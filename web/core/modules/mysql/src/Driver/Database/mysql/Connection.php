...
class Connection extends DatabaseConnection implements SupportsTemporaryTablesInterface {
  ...
  public static function open(array &$connection_options = []) {
    ...
    // Use PHP 8.5+ constants if available, otherwise fall back to deprecated constants.
    $mysql_attr_use_buffered_query = defined('Pdo\Mysql::ATTR_USE_BUFFERED_QUERY') ? \Pdo\Mysql::ATTR_USE_BUFFERED_QUERY : \PDO::MYSQL_ATTR_USE_BUFFERED_QUERY;
    $mysql_attr_found_rows = defined('Pdo\Mysql::ATTR_FOUND_ROWS') ? \Pdo\Mysql::ATTR_FOUND_ROWS : \PDO::MYSQL_ATTR_FOUND_ROWS;
    $mysql_attr_multi_statements = defined('Pdo\Mysql::ATTR_MULTI_STATEMENTS') ? \Pdo\Mysql::ATTR_MULTI_STATEMENTS : \PDO::MYSQL_ATTR_MULTI_STATEMENTS;
    $connection_options['pdo'] += [
      ...
      $mysql_attr_multi_statements => FALSE,
